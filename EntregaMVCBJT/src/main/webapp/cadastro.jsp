  ...
  <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #513443;">
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-md-6">
				<h1 class="mt-5" style="color: #513443;" >Cadastro de Usuário</h1>
				<form class="mt-5" action="CreateController" method="post">
					...
					<button type="submit" class="btn btn-dark btn-lg btn-block mb-5" style="background-color: #513443; border-color: #513443;">Cadastrar</button>
				</form>
			</div>
		</div>
	</div>
